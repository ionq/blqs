...
MappingDisplayGate = cirq_blqs_op.create_cirq_blqs_op(acquaintance.permutation.MappingDisplayGate)
PermutationGate = cirq_blqs_op.create_cirq_blqs_op(acquaintance.permutation.PermutationGate)
